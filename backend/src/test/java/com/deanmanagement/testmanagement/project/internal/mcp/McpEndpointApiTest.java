...
class McpEndpointApiTest {
    ...
    void execution_toolsAreExposed() throws Exception {
        ...
        assertThat(tools.body())
                ...
                .contains("list_test_case_versions")
                .contains("get_test_case_version")
                .contains("get_project_dashboard")
                .contains("list_flaky_tests")
                .contains("get_test_suite_report")
                .contains("list_pipeline_workflows")
                .contains("trigger_pipeline")
                .contains("list_pipeline_runs")
                .contains("get_pipeline_run")
                .contains("refresh_pipeline_run")
                .contains("list_issue_links")
                .contains("link_issue")
                .contains("create_linked_issue")
