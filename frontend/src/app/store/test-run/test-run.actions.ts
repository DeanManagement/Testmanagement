...
export const TestRunActions = createActionGroup({
  ...
  events: {
    ...
    'Load My Active Test Runs': emptyProps(),
    'Load My Active Test Runs Success': props<{ testRuns: TestRun[] }>(),
    'Load My Active Test Runs Failure': props<{ error: string }>(),
    'Load My Completed Test Runs': emptyProps(),
    'Load My Completed Test Runs Success': props<{ testRuns: TestRun[] }>(),
    'Load My Completed Test Runs Failure': props<{ error: string }>(),
  },
});
