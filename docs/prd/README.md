...
| [013](PRD-013-dark-mode-theming.md) | Dark Mode / Theming | S | Proposed |
...
## Status legend
v1.3 PRDs are **Implemented**. v1.4 and v2.0 PRDs are **Proposed**; update the status field as work is picked up and reflect shipped features in `REQUIREMENTS.md`.
